            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('save_flash_sale') }}" method="POST">
                            @csrf
                            <br>
                            <br>
                                    ...
                                    @foreach($product as $item)
                                        <tr>
                                            ...
                                            <td style="width: 140px">
                                                ...
                                                <input type="number" step="any" name="discount_price{{ $item->id }}" id="discount_price{{ $item->id }}" class="form-control discount_price" data-price="{{ $item->id }}">
                                            </td>

                                            <td style="width: 140px">
                                                <input type="number" step="any" name="discount_percentage{{ $item->id }}" id="discount_percentage{{ $item->id }}" class="form-control discount_percentage" data-percentage="{{ $item->id }}">
                                            </td>
