            ...
            <div class="col-md-7">
                ...
                <div id="print_section">
                    <section class="main-pd-wrapper" style="width: 100%; margin: auto">
                        ...
                        <p><span><b>Order id: </b> {{ $saleinvoice->sale_no }}</span> <span style="float: right"><b>Date : </b> {{ $saleinvoice->created_at->format('d/m/Y') }}</span>
                        </p>
                        ...
                        <table style="width: 100%;margin-top: 15px;border: 1px dashed #dddddd;border-radius: 3px;">
                            <thead>
                                <tr>
                                    ...
                                    <td style="text-align: right;"><b>Amount : </b> {{ $saleinvoice->total }} TK.</td>
                                </tr>
                                <tr>
                                    <td>
                                        <b>
