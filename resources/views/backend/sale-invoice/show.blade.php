            ...
            <div class="col-md-7">
                ...
                <div id="print_section">
                    <section class="main-pd-wrapper" style="width: 100%; margin: auto">
                        ...
                        <p><span><b>Sale id: </b> {{ $saleinvoice->sale_no }}</span> <span style="float: right"><b>Date : </b> {{ \Carbon\Carbon::parse($saleinvoice->date)->format('d/m/Y') }}</span>
                        </p>
                        ...
                        <table style="width: 100%;margin-top: 15px;border: 1px dashed #dddddd;border-radius: 3px;">
                            <thead>
                                <tr>
                                    <td>
                                        <b>Name : </b>{{ isset($saleinvoice->customerDetails) ? $saleinvoice->customerDetails->name : '' }} <br>
                                        <b>Phone : </b>{{ isset($saleinvoice->customerDetails) ? $saleinvoice->customerDetails->phone_number : '' }} <br>
                                        <b>Email : </b>{{ isset($saleinvoice->customerDetails) ? $saleinvoice->customerDetails->email : '' }} <br>
                                        <b>Address : </b>{{ isset($saleinvoice->customerDetails) ? $saleinvoice->customerDetails->address : '' }} <br>
                                    </td>

                                    <td style="text-align: right;">
                                        <b>Amount : </b> {{ $saleinvoice->total }} TK. <br>
                                        <b>Discount : </b> {{ $saleinvoice->discount }} TK. <br>
                                        <b>Paid : </b> {{ $saleinvoice->paid }} TK. <br>
                                        <b>Due : </b> {{ $saleinvoice->due }} TK. <br>
                                    </td>
                                </tr>
                            </thead>
                        </table>
