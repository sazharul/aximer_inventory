            ...
            <div class="col-md-12">
                <div class="card mb-0">
                    ...
                    <div class="card-body pos_screen_section">
                        <form method="POST" action="{{ route('purchase.update', $purchase->id) }}" accept-charset="UTF-8" class="form-horizontal"
                                    ...
                                    <div class="form-group {{ $errors->has('supplier_id') ? 'has-error' : ''}}">
                                        ...
                                        <select class="form-control js-example-basic-single" name="supplier_name" required>
                                            ...
                                            @foreach($supplier as $item)
                                                <option
                                                    value="{{ $item->name }}" {{ ($purchase->supplier_name === $item->name) ? 'selected' : '' }}>{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row justify-content-end">
                                <div class="col-sm-3 col-12">
                                    <h5 style="text-align: right;">Grand Total : <b class="grand_total">{{ $purchase->total }}</b></h5>
