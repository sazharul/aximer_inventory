        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/expense/create') }}" class="btn btn-success btn-sm" title="Add New Expense">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        <form method="GET" action="{{ url('/expense') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search"
                                    ...
                                    @foreach($expense as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ url('/expense/' . $item->id . '/edit') }}" title="Edit Expense">
                                                    <button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit
                                                    </button>
                                                </a>

                                                <form method="POST" action="{{ url('/expense' . '/' . $item->id) }}" accept-charset="UTF-8"
