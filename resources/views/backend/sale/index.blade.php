...
{{--                                            <td>{{ $item->status }}</td>--}}
                                            <td>
                                                ...
                                                <a href="{{ url('/sale/' . $item->id . '/edit') }}" title="Edit Sale">
                                                    <button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit
                                                    </button>
                                                </a>

                                                <form method="POST" action="{{ url('/sale' . '/' . $item->id) }}" accept-charset="UTF-8"
                                                ...
                                                <a href="{{ route('sale.show', $item->id) }}" title="Edit Sale">
